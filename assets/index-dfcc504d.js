...
`;function Zg(e,t,n){switch(n){case"bottom-left":return t?Fg:Eg;case"bottom-right":return t?Ug:Cg;case"down":return e?t?Vg:_g:t?Bg:Ng;case"left":return e?t?Hg:Pg:t?Wg:ka;case"right":return e?t?Yg:Tg:t?Qg:jg;case"top-left":return t?Gg:zg;case"top-right":return t?Xg:Rg;case"up":return e?t?Jg:Mg:t?Kg:Ig;default:return t?bg:kg}}const Ea=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=L.useMemo(()=>Zg(t,r,n),[t,n,r]);return se(Qd,{keyframes:i,...o})};E`
  from {
