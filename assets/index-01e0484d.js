...
Coworker at IEC`}}];function d1({testimonialsToDisplayRange:e}){return h.jsx("div",{className:"flex flex-wrap justify-center gap-16",children:Ca.slice(e[0],e[1]).map((t,n)=>h.jsx(Rt,{direction:"up",delay:n*200,triggerOnce:!0,children:h.jsx(p1,{content:t})}))})}const p1=({content:e})=>h.jsxs("div",{className:`bg-zinc-400 bg-opacity-20 flex flex-col gap-8 justify-around shadow p-6 rounded-lg ${vi}`,style:{width:"21.625rem"},children:[h.jsxs("div",{className:"flex flex-col gap-4",children:[h.jsx("div",{children:h.jsx("i",{className:"fa-solid fa-quote-left fa-2xl text-teal-500"})}),h.jsx("p",{className:"text-light text-justify leading-tight whitespace-pre-wrap overflow-ellipsis line-clamp-[14]",children:e.quote})]}),h.jsx(m1,{content:e.person})]}),m1=({content:e})=>h.jsxs("div",{className:"flex gap-4",children:[h.jsx("img",{src:e.image,className:"rounded-full object-fill w-16 h-16"}),h.jsxs("div",{className:"flex flex-col gap-1",children:[h.jsx("h5",{className:"text-light text-lg font-medium leading-relaxed",style:{fontFamily:"Roboto Mono"},children:e.name}),h.jsx("p",{className:"text-stone-300 text-sm whitespace-pre-wrap font-normal capitalize leading-tight",children:e.title})]})]}),Gu=({direction:e,onClick:t,disabled:n})=>{const[r,o]=L.useState(!1);return h.jsxs("button",{className:"bg-white/10 rounded-full w-16 h-16 relative",onMouseEnter:()=>o(!0),onMouseLeave:()=>o(!1),onClick:t,disabled:n,children:[h.jsx("div",{className:"relative z-10",children:h.jsx("i",{className:`fa-solid fa-lg text-light ${e==="LEFT"?"fa-chevron-left":"fa-chevron-right"}`})}),r&&!n&&h.jsx("div",{className:"w-16 h-16 bg-sky-900 rounded-full blur-lg absolute z-0 top-0 left-0"})]})},h1=({testimonialsToDisplayRange:e,setTestimonialsToDisplayRange:t})=>h.jsxs("div",{className:"flex gap-8",children:[h.jsx(Gu,{direction:"LEFT",disabled:e[0]===0,onClick:()=>t(n=>[n[0]-1,n[1]-1])}),h.jsx(Gu,{direction:"RIGHT",disabled:e[1]===Ca.length,onClick:()=>t(n=>[n[0]+1,n[1]+1])})]}),Xu=3;function g1(){const[e,t]=L.useState([0,Xu]);return h.jsxs("div",{className:ne("relative",Vn),id:md,children:[h.jsxs("div",{className:"flex flex-col gap-16 relative z-10",children:[h.jsxs("div",{className:"flex justify-between items-center",children:[h.jsx(xi,{title:["My","Testimonials"]}),Ca.length>Xu&&h.jsx(h1,{testimonialsToDisplayRange:e,setTestimonialsToDisplayRange:t})]}),h.jsx(d1,{testimonialsToDisplayRange:e})]}),h.jsx(yr,{variant:Tn.BLUE,className:"-left-24 top-0 bg-opacity-50"}),h.jsx(yr,{variant:Tn.RED,className:"-right-24 bottom-0 bg-opacity-50"})]})}function y1({content:e}){const[t,n]=L.useState(!1);return h.jsx("a",{href:e.link,style:{height:"28rem"},target:"_blank",children:h.jsxs("div",{className:"bg-zinc-300/10 rounded-lg text-light transition-all",style:{width:"21.25rem",height:t?"28.5rem":"27rem"},onMouseEnter:()=>n(!0),onMouseLeave:()=>n(!1),children:[h.jsxs("div",{className:"relative w-full h-56 flex justify-center items-center bg-cyan-400/10 overflow-clip",children:[h.jsx("img",{src:e.thumbnail,className:"relative z-10 max-h-52 max-w-[80%]"}),h.jsx("div",{className:ne("absolute z-0 w-36 h-36 rounded-full blur-lg bg-cyan-500/20 transition-all",t&&"w-11/12 h-44 bg-cyan-500/40")})]}),h.jsxs("div",{className:"flex flex-col justify-between px-6 h-52",children:[h.jsxs("div",{className:"flex flex-col gap-3 py-6 flex-grow max-h-52",children:[h.jsx("h4",{className:"font-medium tracking-tight leading-none line-clamp-3 text-ellipsis",style:{fontFamily:"Roboto Mono"},children:e.title}),h.jsxs("div",{className:"flex gap-2",children:[h.jsx("div",{className:"w-px h-6 origin-top-left border border-cyan-500"}),h.jsx("p",{children:e.datePosted})]}),h.jsx("p",{className:"text-sm leading-tight text-ellipsis line-clamp-3",children:e.description})]}),h.jsxs("a",{href:e.link,className:ne(t?"block":"hidden","text-teal-500 text-sm font-medium font-['Roboto Mono'] leading-tight"),target:"_blank",children:["Read More ",h.jsx("i",{className:"fa-solid fa-chevron-right"})]})]})]})})}const v1="/assets/supertokens-blog-post-467ca9b8.png",x1="/assets/react-state-management-551cfd8e.png",w1="/assets/typescript-python-2e7c5894.jpeg",S1=[{title:"Setting up Supertokens with a NextJS 13 Frontend and an ExpressJS Backend",link:"https://rohanhussain.com/blog/post/supertokens-with-nextjs-and-expressjs/",description:"This article teaches you how to locally set up a NextJS 13 frontend (with App Router as well as Pages Router) and a separate ExpressJS backend and also explains how the whole setup works.",thumbnail:v1,datePosted:"August 12, 2023"},{title:"State Management Tools in React",link:"https://rohanhussain.com/blog/post/react-state-management-tools/",description:"ContextAPI, Redux, Zustand, Jotai, what to use?",thumbnail:x1,datePosted:"May 8, 2023"},{title:"Typescript-like Types in Python 3",link:"https://rohanhussain.com/blog/post/typescript-like-types-in-python/",description:"def sum(x: int, y: int) -> int",thumbnail:w1,datePosted:"February 14, 2023"}];function k1(){return h.jsxs("div",{className:ne("flex flex-col gap-16",Vn),children:[h.jsx(xi,{title:["My","Blog"]}),h.jsx("div",{className:"flex flex-wrap gap-12 justify-center",style:{gap:"4.375rem"},children:S1.slice(0,3).map((e,t)=>h.jsx(Rt,{direction:"up",delay:t*200,triggerOnce:!0,children:h.jsx(y1,{content:e})}))})]})}function E1(){return h.jsxs("div",{className:ne("py-10 w-full h-44","flex flex-col gap-4 items-center","bg-gradient-to-b from-fuchsia-950/20 from-10 to-cyan-400/0",Vn),id:pd,children:[h.jsxs("div",{className:"flex gap-8",children:[h.jsx(Rt,{direction:"up",triggerOnce:!0,children:h.jsx(Tt,{iconClassNames:"fa-solid fa-phone",link:`tel:${Je.phoneNumber}`})}),h.jsx(Rt,{direction:"up",triggerOnce:!0,children:h.jsx(Tt,{iconClassNames:"fa-regular fa-envelope",link:`mailto:${Je.email}`})}),h.jsx(Rt,{direction:"up",triggerOnce:!0,children:h.jsx(Tt,{iconClassNames:"fa-brands fa-github",link:Je.github})}),h.jsx(Rt,{direction:"up",triggerOnce:!0,children:h.jsx(Tt,{iconClassNames:"fa-brands fa-linkedin-in",link:Je.linkedIn})})]}),h.jsx("p",{className:"text-light",children:"Feel free to contact me"})]})}function C1(){return h.jsxs("div",{className:"bg-slate-950 w-full overflow-x-clip min-h-screen py-6 flex flex-col gap-20",children:[h.jsx(e1,{}),h.jsx(sh,{}),h.jsx(Zg,{}),h.jsx(a1,{}),h.jsx(g1,{}),h.jsx(k1,{}),h.jsx(E1,{})]})}vl.createRoot(document.getElementById("root")).render(h.jsx(ic.StrictMode,{children:h.jsx(C1,{})}));
